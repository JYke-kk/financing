...
<template>
  <div class="app-container">
    ...
    <el-table   v-loading="loading" :data="financingList" @selection-change="handleSelectionChange">
      ...
      <el-table-column  label="众筹项目编号" align="center" prop="id" />
      <el-table-column label="众筹项目名称" align="center" prop="projectName" />
      <el-table-column prop="createTime" label="创建时间" width="150" sortable>
      </el-table-column>
      <el-table-column label="当前众筹人数" align="center" prop="personSum" />
      <el-table-column label="当前众筹金额(单次)" align="center" prop="amount" />
      <el-table-column label="众筹总金额" align="center" prop="amountSum" />
      <el-table-column prop="pic" label="相关图片" min-width="100" sortable>
        <template scope="scope">
          <img :src="imgPrefix+scope.row.pic" width="50">
        </template>
      </el-table-column>
      <el-table-column label="众筹人" align="center" prop="userId" />
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" >
        <template slot-scope="scope" v-if="scope.row.roleId !== 1">
          ...
          <el-button
            ...
            type="text"
            icon="el-icon-delete"
            @click="contributiveTwo(scope.row)"
          >出资</el-button>
          <el-button
            size="mini"
            type="text"
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="众筹金额(单次)" prop="amount">
          <el-input v-model="form.amount" placeholder="请输入众筹金额(单次)" />
        </el-form-item>
        <el-form-item label="图片" prop="pic">
          <el-upload class="upload-demo"
                     action="http://localhost:8080/dev-api/fastDfs/fastDfs"
    ...
    <el-dialog :title="title" :visible.sync="open1" width="1000px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="150px">
        ...
        <el-form-item label="创建时间" prop="createTime">
          <el-input v-model="form.createTime" placeholder="请输入众筹金额(单次)" />
        </el-form-item> <el-form-item label="当前众筹人数" prop="personSum">
          <el-input v-model="form.personSum" placeholder="请输入众筹金额(单次)" />
        </el-form-item>
        <el-form-item label="众筹总金额" prop="amountSum">
          <el-input v-model="form.amountSum" placeholder="请输入众筹金额(单次)" />
        </el-form-item>
        <el-form-item label="众筹人" prop="userId">
          <el-input v-model="form.userId" placeholder="请输入众筹金额(单次)" />
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button @click="cancel">取 消</el-button>
