<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="financingList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="众筹人数" align="center" prop="personSum" />
      <el-table-column label="众筹金额(单次)" align="center" prop="amount" />
      <el-table-column label="众筹总金额" align="center" prop="amountSum" />
      <el-table-column prop="pic" label="图标" min-width="100" sortable>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope" v-if="scope.row.roleId !== 1">
          <el-button
            ...
            v-hasPermi="['system:MyFinancingInfo:remove']"
          >删除当前项目众筹</el-button>
        </template>
      </el-table-column>
    </el-table>
...
import {
  ...
  updateFinancing,
  delFinancing,
  getDelete, contributive, MyFinancingInfo
